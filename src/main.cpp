...
const string strMessageMagic = "IslaCoin Signed Message:\n";
...
static const int POW_BLOCK_COUNT = 110000;
...
bool CBlock::AcceptBlock()
{
    ...
    if (IsProofOfWork() && nHeight > 115380)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "IslaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "IslaCoin, 25 Apr 2015";
        CTransaction txNew;
        txNew.nTime = 1429920000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x03c717318a00b7d3a16113db7180d27439e1acb3b0305f66e0cb58ad927a7413"));
        block.print();
